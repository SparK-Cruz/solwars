 ...
 * @returns {Boolean}
 */
export default function SAT(a :any, b :any, result :Result = null, aabb = true) {
 ...
 * @returns {Boolean}
 */
function polygonPolygon(a :Polygon, b :Polygon, result :Result = null) {
 ...
 * @returns {Boolean}
 */
function polygonCircle(a :Polygon, b :Circle, result :Result = null, reverse = false) {
	const a_coords       = a._coords;
 ...
 * @returns {Boolean}
 */
function circleCircle(a :Circle, b :Circle, result :Result = null) {
 ...
 * @returns {Boolean}
 */
function separatingAxis(a_coords :Float64Array, b_coords :Float64Array, x :number, y :number, result :Result = null) {
