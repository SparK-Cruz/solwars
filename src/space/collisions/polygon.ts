...
export default class Polygon extends Body {
	...
	public _scale_x :number;
	public _scale_y :number;
	public _min_x :number;
	public _min_y :number;
	public _max_x :number;
	public _max_y :number;
